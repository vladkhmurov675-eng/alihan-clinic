...
export default function AdminDashboard({
  ...
  const [doctorForm, setDoctorForm] = useState({
    ...
    weekends: '6,0', disabledDates: '', pin: '1234',
  });
  ...
  const openEditDoctor = (doc: Doctor) => {
    ...
    setDoctorForm({
      ...
      disabledDates: doc.disabledDates, pin: doc.pin,
    });
  ...
  if (!isLoggedIn) {
    return (
      <div className="container" style={{ paddingTop: '4rem', display: 'flex', justifyContent: 'center' }}>
        <div className="glass-panel animate-fade-in" style={{ padding: '3rem', maxWidth: '420px', width: '100%' }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <div style={{
              ...
              <ShieldCheck size={28} style={{ color: 'var(--color-warning)' }} />
            </div>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>Панель администратора</h2>
          ...
          <form onSubmit={handleLogin}>
            <div className="input-group">
              <label className="input-label">PIN-код администратора</label>
              <input
                type="password"
            ...
            <button
              ...
              className={`btn ${loggingIn || !pin ? 'btn-disabled' : 'btn-primary'}`}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  ...
                  <div className="input-group">
                    ...
                    <input
                      ...
                      onChange={e => setDoctorForm(prev => ({ ...prev, pin: e.target.value }))}
                      placeholder="1234"
                    />
                  </div>
                  <div className="input-group">
                  ...
                  <div className="input-group">
                    <label className="input-label">Выходные</label>
                    <input
                      className="form-control" style={{ width: '100%' }}
